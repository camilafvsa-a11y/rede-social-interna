...
const styles = StyleSheet.create({
  ...
  avatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: "#fff", borderWidth: 2, borderColor: "#1E3A8A", alignItems: "center", justifyContent: "center", overflow: "hidden" },
  ...
  searchBar: { flexDirection: "row", alignItems: "center", gap: 8, margin: 12, backgroundColor: C.inputBg, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: C.border },
  ...
  userAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#fff", borderWidth: 1.5, borderColor: "#1E3A8A", alignItems: "center", justifyContent: "center", overflow: "hidden" },
