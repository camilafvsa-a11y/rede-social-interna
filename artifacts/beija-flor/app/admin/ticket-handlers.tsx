...
const styles = StyleSheet.create({
  ...
  avatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: C.tint, alignItems: "center", justifyContent: "center", overflow: "hidden" },
  avatarImg: { width: 44, height: 44, borderRadius: 22 },
  avatarInitial: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 16 },
  handlerInfo: { flex: 1 },
  ...
  userAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: C.tint, alignItems: "center", justifyContent: "center", overflow: "hidden" },
