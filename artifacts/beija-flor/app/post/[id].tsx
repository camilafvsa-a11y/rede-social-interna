...
const styles = StyleSheet.create({
  ...
  commentAvatar: { width: 34, height: 34, borderRadius: 17, backgroundColor: C.tint, alignItems: "center", justifyContent: "center", overflow: "hidden" },
  commentAvatarImg: { width: 34, height: 34, borderRadius: 17 },
  commentAvatarInitial: { color: "#fff", fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  input: {
    ...
    borderWidth: 1, borderColor: C.border, fontFamily: "Inter_400Regular",
  },
