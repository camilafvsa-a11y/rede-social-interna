...
const styles = StyleSheet.create({
  ...
  commentAvatar: { width: 34, height: 34, borderRadius: 17, backgroundColor: "#fff", borderWidth: 1.5, borderColor: "#1E3A8A", alignItems: "center", justifyContent: "center", overflow: "hidden" },
