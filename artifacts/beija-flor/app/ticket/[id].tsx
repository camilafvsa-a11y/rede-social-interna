...
const styles = StyleSheet.create({
  ...
  msgAvatar: { width: 30, height: 30, borderRadius: 15, backgroundColor: C.tint, alignItems: "center", justifyContent: "center", overflow: "hidden" },
  msgAvatarImg: { width: 30, height: 30, borderRadius: 15 },
  msgAvatarInitial: { color: "#fff", fontSize: 12, fontFamily: "Inter_700Bold" },
