...
const styles = StyleSheet.create({
  ...
  msgAvatar: { width: 30, height: 30, borderRadius: 15, backgroundColor: "#fff", borderWidth: 1.5, borderColor: "#1E3A8A", alignItems: "center", justifyContent: "center", overflow: "hidden" },
